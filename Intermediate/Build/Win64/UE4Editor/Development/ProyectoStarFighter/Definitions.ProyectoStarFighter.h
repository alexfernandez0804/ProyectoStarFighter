...
#define UE_PROJECT_NAME ProyectoStarFighter
#define UE_TARGET_NAME ProyectoStarFighterEditor
#define UE_MODULE_NAME "ProyectoStarFighter"
...
#define PROYECTOSTARFIGHTER_API DLLEXPORT
